---
description: >-
  AlphaGo是强化学习与蒙特卡洛树搜索相结合的产物，本章将详细介绍如何实现AlphaGo。本章及下一章将着重介绍AlphaGo和AlphaZero的算法细节，代码由于和之前的重复较多，且都有详细说明过，这两章就不再对代码进行重复解读了。
---
