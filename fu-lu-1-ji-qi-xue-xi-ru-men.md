...
想象一下，你正在创建一家旨在为多家围棋教育机构提供训练程序的初创公司，你的团队打算应用神经网络技术来构建一个超越人类水平的围棋智能程序，并通过该智能程序来提供与人类棋手进行围棋对弈的在线软件。但悲剧的是，目前设计的学习算法还不够好，智能程序的水平也仅仅是比随机下法强那么一丁点，连初级选手也无法击败。为了改进这个程序，你正面临着巨大的压力。可你该怎么做呢？
